@section('footer')
    ...
    <footer id="footer">
        ...
        <div class="footer_bottom">
            <p class="copyright">Copyright &copy; 2021 <a href="#">Sanga-Technology</a></p>
            <p class="developer">Developed By Sanga Technology</p>
        </div>
    </footer>
    ...
    <script src="{{url('frontend/assets/js/jquery.li-scroller.1.0.js')}}"></script>
    <script src="{{url('frontend/assets/js/jquery.newsTicker.min.js')}}"></script>
